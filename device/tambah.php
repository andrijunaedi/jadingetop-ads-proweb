<?php
$title = "Tambah Perangkat | Jadingetop Ads";
$active = "device";
    ...
    <div class="px-4 sm:px-6 lg:px-4">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-3xl font-semibold">Tambah Perangkat</h1>
                <p class="mt-2 text-sm text-gray-700">Tambahkan Perangkat iklan baru</p>
            </div>
        </div>
        <form class="space-y-8 divide-y divide-gray-200" method="POST" action="/device/add.php">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="nama" id="nama" autocomplete="nama" class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="lokasi" id="lokasi" autocomplete="lokasi" placeholder="Masukan lokasi perangkat.." class="block w-full min-w-0 flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                            </div>
                        </div>
